...
export const transtornoDisforicoPreMenstrual: Diagnostico = {
  ...
  entrevistaEstruturada: {
    ...
    algoritmo: {
      ...
      observacaoExclusao:
        "ATENÇÃO — risco de segurança: risco aumentado de ideação suicida no período sintomático (fase lútea) — deve ser rastreado sistematicamente (ex.: escala C-SSRS) mesmo quando o quadro parece remitir por completo fora dessa janela. D: os sintomas estão associados a sofrimento clinicamente significativo ou interferência notável no trabalho, escola, atividades sociais habituais ou relacionamentos. E: a perturbação não pode ser mera exacerbação pré-menstrual de outro transtorno já presente fora da fase lútea (depressão maior, pânico, distimia, transtorno de personalidade) — nesses casos os sintomas basais já existem e só se intensificam antes da menstruação, o que descaracteriza TDPM como diagnóstico primário. G: não atribuível a efeito fisiológico de substância ou outra condição médica.",
    },
  },
};
