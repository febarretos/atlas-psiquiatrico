  ...
  faixas: [
    {
      ...
      cor: "green",
      descricao:
        "Sintomas mínimos ou ausentes. Geralmente não é necessário tratamento farmacológico específico guiado pela escala; manter reavaliação seriada e suporte de enfermagem.",
    },
    {
      min: 10,
      max: 15,
