...
export const barnes: Escala = {
  ...
  notaInterpretacao:
    "A escala BARS original completa também inclui um item de avaliação clínica global da acatisia, pontuado de 0 (ausente) a 5 (acatisia grave com sofrimento intenso e incapacitante), preenchido pelo avaliador com base no conjunto dos itens anteriores — é esse item global, não a soma dos itens 1-3, que tem respaldo direto na literatura original. Nesta versão simplificada, as faixas de 0-9 usam apenas a soma dos 3 itens centrais (objetivo, subjetivo e sofrimento) como aproximação prática para rastreio e monitoramento longitudinal, sem corte publicado equivalente ao item global — na dúvida clínica, priorize o julgamento do item global sobre o ponto de corte da soma. A acatisia é um efeito adverso extrapiramidal comum a antipsicóticos (especialmente de primeira geração e alguns de segunda geração) e deve ser diferenciada de agitação psicótica ou ansiedade, já que seu manejo (redução de dose, troca de antipsicótico, betabloqueador ou benzodiazepínico) difere do manejo da agitação primária.",
