...
export const oTeoremaDasAntenasDoSeuVanderlei: CasoClinico = {
  id: "o-teorema-das-antenas-do-seu-vanderlei",

  titulo: "O Teorema das Antenas do Seu Vanderlei",

  categoria: "Transtornos Psicóticos",

  apresentacaoInicial:
    "Paciente do sexo masculino, 28 anos, trazido pela irmã (Dona Valéria) com olhar esquivo e braços cruzados. Há 8 meses abandonou o emprego na marcenaria, cobriu as janelas do quarto com papel-alumínio e insiste que o relógio de luz do corredor transmite frequências eletromagnéticas para roubar seus pensamentos. Fala sozinho e diz ouvir fofocas vindas das tomadas.",
  ...
  nos: [
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "A anamnese detalhada confirma mais de 6 meses de sintomas ativos e residuais com impacto funcional marcante. Para cumprir o Critério E do DSM-5 e descartar etiologias secundárias, você solicita exames laboratoriais (hemograma, TSH, função renal/hepática, eletrólitos, sorologias, toxicológico de urina) e TC de crânio. Todos os resultados retornam estritamente normais.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "Você solicitou apenas hemograma e glicemia de jejum, omitindo a triagem toxicológica e a avaliação metabólica/neurológica completa. Os exames básicos vêm sem alterações, mas você ainda não tem certeza absoluta sobre o tempo exato de evolução nem sobre ausência de substâncias.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "A precipitação diagnóstica gerou ruído na relação médico-paciente. Dona Valéria traz exames de sangue recentes de um atendimento de urgência sem alterações relevantes, mas você não realizou o exame físico neurológico adequado nem confirmou os critérios para transtorno psicótico primário.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "Devido ao confronto inicial, Vanderlei está mutista e desconfiado no canto da sala. Valéria chora e fornece as informações: 8 meses de isolamento, vozes das tomadas e prejuízo funcional. Exames laboratoriais de rotina foram colhidos na semana anterior e estão normais.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "O antipsicótico de segunda geração foi bem instituído em dose terapêutica inicial adequada. Na consulta de retorno após 3 semanas, Dona Valéria relata que Vanderlei está mais calmo, parou de falar com as tomadas e aceitou retirar parte do papel-alumínio das janelas. Ele nega efeitos colaterais graves.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "Na avaliação de retorno após 3 semanas, Vanderlei apresenta melhora discreta. Ele ainda acredita que o relógio de luz monitora seus passos, mas o impacto emocional reduziu. Entretanto, relata inquietação nas pernas que o impede de ficar sentado (acatisia discreta).",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "A conduta inicial inadequada (dose excessiva, Clozapina sem critérios ou contenção) gerou complicações. Vanderlei retorna extremamente sedado, com sialorreia ou rigidez marcada. Valéria está desesperada achando que o irmão enlouqueceu de vez devido ao remédio.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "Após 3 semanas usando dose subterapêutica, Vanderlei não apresentou qualquer melhora. Ele trancou o relógio de luz com uma corrente, parou totalmente de tomar banho por medo da água energizada e as alucinações auditivas continuam intensas.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "Sem antipsicótico prescrito, Vanderlei piora rapidamente. Duas semanas depois, ele ameaçou o síndico com um martelo para tentar arrancar o relógio de luz do prédio. A polícia foi acionada e o trouxe ao pronto-socorro psiquiátrico acompanhado da irmã.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "evolucao",
      narrativa:
        "Vanderlei teve melhora parcial dos sintomas. As vozes das tomadas tornaram-se sussurros esporádicos, mas ele ainda evita o corredor do prédio e apresenta apatia marcante e lentificação (sintomas negativos/residuais). A irmã relata que ele passa o dia sentado na sala sem iniciativa.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "evolucao",
      narrativa:
        "O manejo inadequado resultou em deterioração do caso. Vanderlei está em exacerbação psicótica grave, recusa alimentos achando que estão envenenados pela rede elétrica e apresenta agitação psicomotora intermitente com prejuízo funcional total.",
      opcoes: [
        {
  ...
  diagnosticoFinal:
    "Esquizofrenia, com delírios persecutórios/bizarros (fiação clandestina, monitoramento por antenas/tomadas) e alucinações auditivas, com mais de 6 meses de evolução e prejuízo funcional marcante.",

  diagnosticoId: "esquizofrenia",
  ...
  pontosDeEnsino: [
    "O diagnóstico de esquizofrenia exige investigação ativa da duração (>=6 meses de sintomas ativos e residuais) e exclusão de causas orgânicas/uso de substâncias antes de fechar o critério E — atalhos diagnósticos comprometem o raciocínio clínico e a relação terapêutica.",
    "Confrontar diretamente o conteúdo delirante do paciente tende a romper a aliança terapêutica sem trazer benefício clínico — validar o sofrimento sem endossar o delírio é a abordagem mais eficaz.",
    "Erros posológicos (dose subterapêutica, dose excessiva, Clozapina sem critérios de refratariedade e sem monitorização hematológica) são fonte comum de efeitos adversos evitáveis e de falha terapêutica aparente.",
    "Acatisia e outros sintomas extrapiramidais devem ser tratados ativamente (ajuste de dose, propranolol) — não são \"esperados\" nem devem ser ignorados, sob risco de abandono do tratamento pelo paciente.",
    "Sintomas negativos/residuais (apatia, avolia) respondem mal a aumento de dose de antipsicótico e exigem abordagem psicossocial ativa (reabilitação, treino de habilidades sociais) para melhora funcional real.",
    "Esquizofrenia é uma condição crônica — suspensão da medicação de manutenção após remissão sintomática, mesmo completa, tem alto risco de recaída.",
  ],
