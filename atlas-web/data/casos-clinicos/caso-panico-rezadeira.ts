...
export const casoPanicoRezadeira: CasoClinico = {
  id: "caso-panico-rezadeira",

  titulo: "O Santo, o Demônio e a Taquicardia de Dona Lurdes",

  categoria: "Transtornos de Ansiedade",

  apresentacaoInicial:
    "Paciente do sexo feminino, 54 anos, rezadeira respeitada em sua comunidade, trazida pela filha por episódios recorrentes de início súbito com gritos, tremor, sensação de garganta fechando e queimação no peito, interpretados pela família como possessão espiritual — o próprio padre da paróquia orientou a busca por avaliação médica. A paciente relata sentir que vai morrer ou enlouquecer durante as crises, que atingem o pico em minutos, e evita sair de casa por medo de nova crise.",
  ...
  nos: [
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "A história clínica é altamente sugestiva de crises paroxísticas de ansiedade e apreensão persistente. No entanto, é fundamental afastar etiologias orgânicas antes de fechar o diagnóstico e pactuar o plano terapêutico com a paciente e sua família.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "A paciente aguarda na sala. A investigação clínica foi parcial até o momento e os sintomas continuam trazendo imenso sofrimento funcional a Dona Lurdes.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "exames",
      narrativa:
        "O clima na consulta ficou tenso devido à abordagem inicial empobrecida. A paciente está assustada e a filha bastante defensiva.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "Com os exames normais e o diagnóstico de Transtorno do Pânico estabelecido, é hora de planejar a intervenção terapêutica. A paciente teme ficar 'viciada em remédio tarja preta' e precisa de psicoeducação clara sobre a natureza autolimitada e neurobiológica das crises.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "O diagnóstico de pânico está traçado, mas o plano farmacológico e a aliança terapêutica ainda precisam ser consolidados com rigor técnico.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "conduta",
      narrativa:
        "Após atritos e condutas truncadas, a paciente se encontra apreensiva. É necessário ajustar a conduta antes que ela abandone o segmento clínico.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "evolucao",
      narrativa:
        "Dona Lurdes retorna ao consultório após 4 semanas. Ela entra sorridente, sem a arruda na mão. A filha relata: 'Doutor, ela é outra pessoa! Entendeu que o peito acelerado era só um alarme do corpo e não o demônio. Não teve mais nenhuma crise forte e até voltou a rezar nas vizinhas.'",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "evolucao",
      narrativa:
        "Dona Lurdes retorna após 4 semanas. Apresenta melhora parcial: as crises de pânico estão menos intensas e menos frequentes, mas ela ainda sente medo constante de ter novos episódios e evita sair desacompanhada.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "evolucao",
      narrativa:
        "Dona Lurdes retorna em péssimas condições. Ela teve exacerbação grave da ansiedade nos primeiros dias de tratamento incorreto, abandonou o remédio e agora passa o dia trancada no quarto com medo de morrer a qualquer momento.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "desfecho",
      narrativa:
        "Desfecho Desfavorável: Erros na abordagem inicial, iatrogenias farmacológicas (dose inicial excessiva de ISRS ou uso isolado de neurolépticos/sedativos) e falta de aliança terapêutica levaram Dona Lurdes ao agravamento da esquiva agorafóbica e à desconfiança do tratamento psiquiátrico. A paciente permanece restrita ao leito e ao lar, sofrendo com crises recorrentes e prejuízo funcional grave.",
      opcoes: [],
    },
  ],

  diagnosticoFinal:
    "Transtorno do Pânico, apresentação moldada por contexto cultural/religioso (interpretada pela família como possessão espiritual), sem sintomas psicóticos.",
  ...
  pontosDeEnsino: [
    "Sintomas de pânico podem ser interpretados pelo paciente e pela família através de um referencial cultural/religioso (ex.: possessão espiritual) — isso não invalida o diagnóstico psiquiátrico nem deve ser motivo de julgamento; acolher a explicação do paciente sem confrontá-la é parte da aliança terapêutica.",
    "Exames básicos (ECG, TSH, hemograma, glicemia) devem ser solicitados de forma direcionada para afastar diferenciais relevantes (arritmia, hipertireoidismo) — sem cair no exagero de bateria extensa e cara, que atrasa o tratamento e reforça a crença de doença física oculta.",
    "ISRS devem ser iniciados em dose baixa no Transtorno do Pânico, com titulação gradual — dose inicial plena pode desencadear hiperativação/piora ansiogênica precoce e levar ao abandono do tratamento.",
    "Benzodiazepínico como monoterapia de longo prazo não trata o transtorno de base e traz risco de tolerância e dependência — papel é adjuvante e pontual, sobretudo nas primeiras semanas até o ISRS fazer efeito.",
    "Antipsicóticos/sedativos pesados não têm indicação no Transtorno do Pânico e podem causar iatrogenia grave (acatisia, distonia) sem tratar os sintomas centrais.",
    "Suspender o tratamento cedo demais (antes de 6-12 meses de manutenção após remissão) tem alto risco de recaída — a resposta inicial não deve ser confundida com cura definitiva.",
  ],
