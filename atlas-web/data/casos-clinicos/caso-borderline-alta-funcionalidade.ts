...
export const casoBorderlineAltaFuncionalidade: CasoClinico = {
  id: "caso-borderline-alta-funcionalidade",

  titulo: "A Arquiteta, a Maquete Desmoronada e o Vazio de Luxo",

  categoria: "Transtornos de Personalidade",

  apresentacaoInicial:
    "Paciente do sexo feminino, 30 anos, arquiteta renomada e premiada, trazida pela irmã ao ambulatório. Veste-se com postura impecável e altiva, mas dissolve-se em lágrimas nos primeiros minutos de consulta. Relata recaída no consumo de álcool após o noivo pedir 'um tempo', sentimento de vazio intolerável que tenta preencher com trabalho excessivo, e medo intenso de ficar sozinha. Nega cortes ou tentativas de suicídio explícitas — 'ela sempre pareceu tão forte e no controle de tudo', comenta a irmã.",
  ...
  nos: [
    ...
    },
    {
      ...
      turno: "evolucao",
      narrativa:
        "Após a reorientação do diagnóstico para TP Borderline e a pactuação de um plano focado em psicoterapia DBT, Camilla conseguiu retomar os trilhos do tratamento. O vínculo médico-paciente foi recuperado e a paciente demonstra alívio por entender os padrões de sua instabilidade.",
      opcoes: [
        {
    ...
    },
    {
      ...
      turno: "desfecho",
      narrativa:
        "Desfecho moderado. O manejo sofreu com atrasos no diagnóstico de certeza, foco excessivo em sintomas secundários (como o uso de álcool) ou uso de polifarmácia adjuvante acentuada. Embora a paciente tenha sido mantida em acompanhamento e não tenha ocorrido tragédia maior, a falta de centralidade na psicoterapia estruturada manteve certa vulnerabilidade interpessoal e episódios residuais de instabilidade.",
      opcoes: [],
    },
    {
    ...
    },
    {
      ...
      turno: "desfecho",
      narrativa:
        "Desfecho desfavorável por negligência diagnóstica. Atribuir o sofrimento crônico e a instabilidade afetiva severa da paciente a uma mero 'estresse passageiro de término de relacionamento' deixou-a desamparada, resultando em agravamento imediato da crise disfórica e recaída alcoólica importante sem qualquer suporte de segurança.",
      opcoes: [],
    },
  ],

  diagnosticoFinal:
    "Transtorno de Personalidade Borderline, apresentação de alta funcionalidade (subtipo internalizante), com uso de álcool como comportamento impulsivo secundário à desregulação emocional.",

  diagnosticoId: "personalidade-borderline",

  medicamentosRelacionados: ["quetiapina", "litio"],

  pontosDeEnsino: [
    "O Transtorno de Personalidade Borderline pode se apresentar com alta funcionalidade profissional (subtipo internalizante) — sucesso aparente e postura controlada não excluem sofrimento interno grave nem instabilidade interpessoal significativa.",
    "Uso problemático de substâncias, sintomas depressivos e ideação paranoide transitória sob estresse são frequentemente secundários à desregulação emocional do TPB, não diagnósticos primários isolados — tratar só o sintoma de superfície deixa o quadro central sem abordagem.",
    "O principal diagnóstico diferencial de humor é o Transtorno Bipolar: no TPB a instabilidade afetiva é reativa a gatilhos interpessoais e dura horas, diferente dos episódios de humor bipolares, que são mais sustentados e menos reativos a estímulos pontuais.",
    "A Terapia Comportamental Dialética (DBT) é o tratamento de primeira linha — farmacoterapia tem papel adjuvante e sintomático; polifarmácia extensa não trata o núcleo interpessoal/afetivo do transtorno e aumenta o risco de efeitos adversos.",
    "Limites terapêuticos claros e um plano de crise pactuado (não disponibilidade pessoal irrestrita do profissional) são parte central do manejo — quebrar o enquadre por medo de 'abandonar' o paciente tende a intensificar a dependência e a instabilidade, não reduzi-las.",
  ],
