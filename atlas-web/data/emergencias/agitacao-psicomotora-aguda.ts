...
export const agitacaoPsicomotoraAguda: Emergencia = {
  ...
  condutaImediata: [
    ...
    "Na intoxicação aguda por álcool ou outro depressor do SNC, antipsicótico isolado costuma ser preferível a benzodiazepínico (Project BETA) — associar ou dar sequência com benzodiazepínico soma o risco de depressão respiratória a quem já está sob efeito de um depressor do SNC. Benzodiazepínico isolado é indicado na abstinência alcoólica/de benzodiazepínicos, não na intoxicação",
    "Evitar associar olanzapina intramuscular a benzodiazepínico parenteral, tanto na mesma administração quanto nas horas seguintes a uma ou outra — essa combinação tem alerta de bula por risco de sedação excessiva e depressão cardiorrespiratória",
